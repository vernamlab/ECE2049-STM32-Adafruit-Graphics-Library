...
/**
 * @brief Internal handle used to store the instance of an Adafruit_ST7735 class for use in the C API functions. This struct is not 
 ...
 *        the C++ class instance for the ST7735 display.
 * 
 */
 ...
 * @param cs The pin number for the TFT display's CS pin. Will come from a macro with the pin label generated by STM32CubeMX
 * @param cs_port The STM32 GPIO port for the TFT display's CS pin. Predefined macro for the GPIO port associated with the CS pin
 * @param dc The pin number for the TFT display's DC pin. Will come from a macro with the pin label generated by STM32CubeMX
 * @param dc_port The STM32 GPIO port for the TFT display's DC pin. Predefined macro for the GPIO port associated with the DC pin
 */
